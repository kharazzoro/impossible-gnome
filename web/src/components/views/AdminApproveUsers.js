...
export default class AdminApproveUsers extends Component {
  state = {
                          ...
                          <Fragment key={index}>
                            ...
                            >
                              <Input
                                ...
                                type="checkbox"
                                value={email}
                                checked={this.state.listOfEmailsApproved.has(
                                  email
                                )}
            ...
            <Row id="noEmailForApprovalErrorMessageContainer">
              ...
              <Col sm={7}>
                {this.state.disableDropdownAndApproveButton ? (
                  <p>
                    There is no organisation that needs approval at the moment
                  </p>
                ) : null}
              </Col>
              <Col sm={1} />
